...
public class MenuScreen implements Screen {
	...
	public MenuScreen(Game game, ClientUI clientUI, SpriteBatch batch, TiledMap tiledMap, DataInfusedTileMap tileMap, TiledMapRenderer tiledMapRenderer, Rectangle viewport, Stage tiledMapStage, FitViewport worldViewport, OrthographicCamera tileCamera) {
		this.game = game;
	...
	public void create() {
		...
		startButton.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				game.setScreen(new GameScreen(game, clientUI, batch, tiledMap, tileMap, tiledMapRenderer, viewport, tiledMapStage, worldViewport, tileCamera));
			}
		});
